...
class escadaFalse {
  ...
  void desenha () {
    rectMode(CENTER);
    fill(3, 166, 150);
    rect(escadaFX, escadaFY - 30, 25, 40);
    rect(escadaFX, escadaFY + 30, 25, 40);
  }
}

class Fogo {
  int fogoX, fogoY, variaFogoX, variaFogoY;
  float teste;
  Fogo() {
    fogoX = 100;
    fogoY = 160;
  ...
  void desenha() {
    fill(255, 165, 0);
    ellipse(fogoX, fogoY, 20, 20);
    mover();
    bateu();
  }
  void mover() {
    fogoY = fogoY + variaFogoY;
    fogoX = fogoX + variaFogoX;
    if (fogoY >= 660 && fogoX == 100) {
      variaFogoX = 5;
      variaFogoY = 0;
    }
    if (fogoX <= 90) {
    ...
    if (fogoY >= 660) {
      if (fogoX == ef1.escadaFX || fogoX == e1.escadaTX) {
        teste = (int)random(2);
        if (teste >= 1) {
          variaFogoX = 0;
          variaFogoY = -5;
    ...
    if (fogoY == 560 && teste == 2) {
      variaFogoX = 5;
      variaFogoY = 0;
      teste = 0;
    }
    if (fogoY == 560 && (fogoX == e2.escadaTX || fogoX == e3.escadaTX)) {
      teste = (int)random(2);
      if (teste >= 1) {
        variaFogoX = 0;
        variaFogoY = -5;
    ...
    if (fogoY == 460 && teste == 2) {
      variaFogoX = 5;
      variaFogoY = 0;
      teste = 0;
    }
    if (fogoY == 460 && (fogoX == e4.escadaTX || fogoX == e5.escadaTX || fogoX == ef2.escadaFX)) {
      teste = (int)random(2);
      if (teste >= 1) {
        variaFogoX = 0;
        variaFogoY = -5;
    ...
    if (fogoY == 360 && teste == 2) {
      variaFogoX = 5;
      variaFogoY = 0;
      teste = 0;
    }
    if (fogoY == 360 && (fogoX == e6.escadaTX || fogoX == e7.escadaTX || fogoX == ef3.escadaFX)) {
      teste = (int)random(2);
      if (teste >= 1) {
        variaFogoX = 0;
        variaFogoY = -5;
    ...
    if (fogoY == 260 && teste == 2) {
      variaFogoX = 5;
      variaFogoY = 0;
      teste = 0;
    }
    if (fogoY == 260 && (fogoX == e8.escadaTX || fogoX == ef4.escadaFX)) {
      teste = (int)random(2);
      if (teste >= 1) {
        variaFogoX = 0;
        variaFogoY = -5;
    ...
    if (fogoY == 160 && teste == 2) {
      variaFogoX = 5;
      variaFogoY = 0;
      teste = 0;
    }
    if (fogoY == 160 && fogoX == 100) {
      variaFogoX = 0;
      variaFogoY = 5;
    }
  }
  ...
  void bateu() {
    if (fogoX+10 >= m.marioX-10 && fogoX-10 <= m.marioX+10 && fogoY <= m.marioY+15 && fogoY >= m.marioY-15) {
      bate = true;
    }
  }
}
